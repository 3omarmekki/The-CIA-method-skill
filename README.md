...
The skill is a single portable `SKILL.md`, so installing it is just copying one file into any agent's skills directory (see the table below for the exact path).
...
cp /tmp/cia-skill/SKILL.md ~/.agents/skills/cia/SKILL.md
```
...
Copy-Item "$env:TEMP\cia-skill\SKILL.md" "$env:USERPROFILE\.agents\skills\cia\SKILL.md"
```
...
cp /tmp/cia-skill/SKILL.md ~/.config/opencode/skills/cia/SKILL.md
# or project-scoped:
mkdir -p .opencode/skills/cia
cp /tmp/cia-skill/SKILL.md .opencode/skills/cia/SKILL.md
```
...
Copy-Item "$env:TEMP\cia-skill\SKILL.md" "$env:USERPROFILE\.config\opencode\skills\cia\SKILL.md"
```
...
cp /tmp/cia-skill/SKILL.md ~/.codex/skills/cia/SKILL.md
# or project-scoped:
mkdir -p .codex/skills/cia
cp /tmp/cia-skill/SKILL.md .codex/skills/cia/SKILL.md
```
...
Copy-Item "$env:TEMP\cia-skill\SKILL.md" "$env:USERPROFILE\.codex\skills\cia\SKILL.md"
```
...
cp /tmp/cia-skill/SKILL.md ~/.claude/skills/cia/SKILL.md
# or project-scoped:
mkdir -p .claude/skills/cia
cp /tmp/cia-skill/SKILL.md .claude/skills/cia/SKILL.md
```
...
Copy-Item "$env:TEMP\cia-skill\SKILL.md" "$env:USERPROFILE\.claude\skills\cia\SKILL.md"
```
...
cp /tmp/cia-skill/SKILL.md ~/.gemini/skills/cia/SKILL.md
```
...
Copy-Item "$env:TEMP\cia-skill\SKILL.md" "$env:USERPROFILE\.gemini\skills\cia\SKILL.md"
```
...
cp /tmp/cia-skill/SKILL.md ~/.kimi/skills/cia/SKILL.md
# or project-scoped:
mkdir -p .kimi-code/skills/cia
cp /tmp/cia-skill/SKILL.md .kimi-code/skills/cia/SKILL.md
```
...
Copy-Item "$env:TEMP\cia-skill\SKILL.md" "$env:USERPROFILE\.kimi\skills\cia\SKILL.md"
```
...
cp /tmp/cia-skill/SKILL.md ~/.cursor/skills/cia/SKILL.md
# or project-scoped:
mkdir -p .cursor/skills/cia
cp /tmp/cia-skill/SKILL.md .cursor/skills/cia/SKILL.md
```
...
Copy-Item "$env:TEMP\cia-skill\SKILL.md" "$env:USERPROFILE\.cursor\skills\cia\SKILL.md"
```
...
cp /tmp/cia-skill/SKILL.md .github/copilot/skills/cia/SKILL.md
